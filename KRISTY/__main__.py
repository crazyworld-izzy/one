...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="KRISTY_admin"),
    ...
    if query.data == "KRISTY_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ᴍᴜꜱɪᴄ", url="https://telegra.ph/ᴀʟᴏɴᴇ-01-06"),
